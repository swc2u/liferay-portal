...
if (!BrowserSnifferUtil.isMobile(request)) {
	...
	SimpleDateFormat shortDateFormatSimpleDateFormat = new SimpleDateFormat("dd/MM/yyyy");
...
String[] dateAbbreviations = {"d","M","y"};
String[] localizedDateAbbreviations = {dayAbbreviation, monthAbbreviation, yearAbbreviation};
