...
<portlet:renderURL var="appointeeMapperURL">
	<portlet:param name="mvcRenderCommandName" value="/appointmentAdmin/manage_appointee_mapper" />
	<portlet:param name="redirect" value="<%= currentUrl %>" />
</portlet:renderURL>

<div class="col-md-6" style="float:right;">
	<a href="<%=appointeeMapperURL %>"><aui:button type="add" value="Map Approver"/></a>
</div>
