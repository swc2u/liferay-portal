...
<%
String orderByCol = ParamUtil.getString(request, "orderByCol","createdDate"); 
...
List<CsclAppointmentMaster> tempAppointmentList = CsclAppointmentMasterLocalServiceUtil.getCsclAppointmentMasters(QueryUtil.ALL_POS,QueryUtil.ALL_POS);
List<CsclAppointmentMaster> appointmentList = new ArrayList<CsclAppointmentMaster>(tempAppointmentList);
System.out.println("tempAppointmentList"+tempAppointmentList);
PortletURL iteratorURL = renderResponse.createRenderURL();
iteratorURL.setParameter("jspPage", "/appointmentAdmin/view.jsp");
...
<liferay-ui:search-container-results >
    ...
    <liferay-ui:search-container-row
        ...
        <liferay-ui:search-container-column-text name="reason">
        	<%=CommonUtil.getTextFromXml(appointmentMaster.getReason(), locale) %>
        </liferay-ui:search-container-column-text>
        ...
        <liferay-ui:search-container-column-text name="<%=LanguageUtil.get(locale, "preferedTime") %>" orderable="true" orderableProperty="preferedTime">
