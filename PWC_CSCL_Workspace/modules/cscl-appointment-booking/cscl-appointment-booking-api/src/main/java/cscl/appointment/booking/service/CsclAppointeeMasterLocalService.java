...
/**
 * Provides the local service interface for CsclAppointeeMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author @rnab
 * @see CsclAppointeeMasterLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CsclAppointeeMasterLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CsclAppointeeMasterLocalServiceUtil} to access the cscl appointee master local service. Add custom service methods to <code>cscl.appointment.booking.service.impl.CsclAppointeeMasterLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
