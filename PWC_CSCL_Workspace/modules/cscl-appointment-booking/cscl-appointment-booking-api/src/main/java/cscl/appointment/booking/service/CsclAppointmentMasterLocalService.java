...
/**
 * Provides the local service interface for CsclAppointmentMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author @rnab
 * @see CsclAppointmentMasterLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CsclAppointmentMasterLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CsclAppointmentMasterLocalServiceUtil} to access the cscl appointment master local service. Add custom service methods to <code>cscl.appointment.booking.service.impl.CsclAppointmentMasterLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CsclAppointmentMaster> getAppointmentsWithStatus(
		int appointee, int status);
