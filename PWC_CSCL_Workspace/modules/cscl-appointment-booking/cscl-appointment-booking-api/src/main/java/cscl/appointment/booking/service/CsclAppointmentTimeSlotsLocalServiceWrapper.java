...
/**
 * Provides a wrapper for {@link CsclAppointmentTimeSlotsLocalService}.
 *
 * @author @rnab
 * @see CsclAppointmentTimeSlotsLocalService
 * @generated
 */
public class CsclAppointmentTimeSlotsLocalServiceWrapper
	implements CsclAppointmentTimeSlotsLocalService,
			   ServiceWrapper<CsclAppointmentTimeSlotsLocalService> {

	public CsclAppointmentTimeSlotsLocalServiceWrapper(
		CsclAppointmentTimeSlotsLocalService
			csclAppointmentTimeSlotsLocalService) {

		_csclAppointmentTimeSlotsLocalService =
			csclAppointmentTimeSlotsLocalService;
	}
	 ...
	 */
	@Override
	public cscl.appointment.booking.model.CsclAppointmentTimeSlots
		addCsclAppointmentTimeSlots(
			cscl.appointment.booking.model.CsclAppointmentTimeSlots
				csclAppointmentTimeSlots) {

		return _csclAppointmentTimeSlotsLocalService.
			addCsclAppointmentTimeSlots(csclAppointmentTimeSlots);
	}
	...
	public cscl.appointment.booking.model.CsclAppointmentTimeSlots
		...
		return _csclAppointmentTimeSlotsLocalService.
			createCsclAppointmentTimeSlots(id_);
	}
	...
	public cscl.appointment.booking.model.CsclAppointmentTimeSlots
		...
		return _csclAppointmentTimeSlotsLocalService.
			deleteCsclAppointmentTimeSlots(csclAppointmentTimeSlots);
	}
	...
	public cscl.appointment.booking.model.CsclAppointmentTimeSlots
		...
		return _csclAppointmentTimeSlotsLocalService.
			deleteCsclAppointmentTimeSlots(id_);
	}
	...
	public com.liferay.portal.kernel.model.PersistedModel deletePersistedModel(
		...
		return _csclAppointmentTimeSlotsLocalService.deletePersistedModel(
			persistedModel);
	}

	@Override
	public com.liferay.portal.kernel.dao.orm.DynamicQuery dynamicQuery() {
		return _csclAppointmentTimeSlotsLocalService.dynamicQuery();
	}
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		return _csclAppointmentTimeSlotsLocalService.dynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return _csclAppointmentTimeSlotsLocalService.dynamicQueryCount(
			dynamicQuery);
	}
	...
	public cscl.appointment.booking.model.CsclAppointmentTimeSlots
		...
		return _csclAppointmentTimeSlotsLocalService.
			fetchCsclAppointmentTimeSlots(id_);
	}
	...
	public cscl.appointment.booking.model.CsclAppointmentTimeSlots
		...
		return _csclAppointmentTimeSlotsLocalService.
			getCsclAppointmentTimeSlots(id_);
	}
	...
	public java.util.List
		...
		return _csclAppointmentTimeSlotsLocalService.
			getCsclAppointmentTimeSlotses(start, end);
	}
	...
	public int getCsclAppointmentTimeSlotsesCount() {
		return _csclAppointmentTimeSlotsLocalService.
			getCsclAppointmentTimeSlotsesCount();
	}
	...
	public String getOSGiServiceIdentifier() {
		return _csclAppointmentTimeSlotsLocalService.getOSGiServiceIdentifier();
	}
	...
	public com.liferay.portal.kernel.model.PersistedModel getPersistedModel(
		...
		return _csclAppointmentTimeSlotsLocalService.getPersistedModel(
			primaryKeyObj);
	}
	...
	public cscl.appointment.booking.model.CsclAppointmentTimeSlots
		...
		return _csclAppointmentTimeSlotsLocalService.
			updateCsclAppointmentTimeSlots(csclAppointmentTimeSlots);
	}

	@Override
	public CsclAppointmentTimeSlotsLocalService getWrappedService() {
		return _csclAppointmentTimeSlotsLocalService;
	}
	...
	private CsclAppointmentTimeSlotsLocalService
		_csclAppointmentTimeSlotsLocalService;
