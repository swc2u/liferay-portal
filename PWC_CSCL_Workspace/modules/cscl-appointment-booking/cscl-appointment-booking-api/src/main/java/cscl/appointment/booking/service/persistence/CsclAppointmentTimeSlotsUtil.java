...
/**
 * The persistence utility for the cscl appointment time slots service. This utility wraps <code>cscl.appointment.booking.service.persistence.impl.CsclAppointmentTimeSlotsPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 *
 * @author @rnab
 * @see CsclAppointmentTimeSlotsPersistence
 * @generated
 */
public class CsclAppointmentTimeSlotsUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(csclAppointmentTimeSlots);
	}
	 ...
	 */
	public static Map<Serializable, CsclAppointmentTimeSlots>
	 ...
	 */
	public static List<CsclAppointmentTimeSlots> findWithDynamicQuery(
	 ...
	 */
	public static CsclAppointmentTimeSlots update(
		CsclAppointmentTimeSlots csclAppointmentTimeSlots) {

		return getPersistence().update(csclAppointmentTimeSlots);
	}
	...
	public static CsclAppointmentTimeSlots update(
		...
		return getPersistence().update(
			csclAppointmentTimeSlots, serviceContext);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(csclAppointmentTimeSlots);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(csclAppointmentTimeSlotses);
	}
	 ...
	 */
	public static CsclAppointmentTimeSlots create(long id_) {
	 ...
	 */
	public static CsclAppointmentTimeSlots remove(long id_)
		throws cscl.appointment.booking.exception.
			NoSuchCsclAppointmentTimeSlotsException {

		return getPersistence().remove(id_);
	}

	public static CsclAppointmentTimeSlots updateImpl(
		CsclAppointmentTimeSlots csclAppointmentTimeSlots) {

		return getPersistence().updateImpl(csclAppointmentTimeSlots);
	}
	 ...
	 * @throws NoSuchCsclAppointmentTimeSlotsException if a cscl appointment time slots with the primary key could not be found
	 */
	public static CsclAppointmentTimeSlots findByPrimaryKey(long id_)
		throws cscl.appointment.booking.exception.
			NoSuchCsclAppointmentTimeSlotsException {
	 ...
	 */
	public static CsclAppointmentTimeSlots fetchByPrimaryKey(long id_) {
	 ...
	 */
	public static List<CsclAppointmentTimeSlots> findAll() {
	 ...
	 */
	public static List<CsclAppointmentTimeSlots> findAll(int start, int end) {
	...
	public static CsclAppointmentTimeSlotsPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<CsclAppointmentTimeSlotsPersistence,
		 CsclAppointmentTimeSlotsPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CsclAppointmentTimeSlotsPersistence.class);

		ServiceTracker
			<CsclAppointmentTimeSlotsPersistence,
			 CsclAppointmentTimeSlotsPersistence> serviceTracker =
				new ServiceTracker
					<CsclAppointmentTimeSlotsPersistence,
					 CsclAppointmentTimeSlotsPersistence>(
						 bundle.getBundleContext(),
						 CsclAppointmentTimeSlotsPersistence.class, null);
