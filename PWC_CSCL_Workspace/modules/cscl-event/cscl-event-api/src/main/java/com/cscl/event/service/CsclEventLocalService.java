...
/**
 * Provides the local service interface for CsclEvent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CsclEventLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CsclEventLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CsclEventLocalServiceUtil} to access the cscl event local service. Add custom service methods to <code>com.cscl.event.service.impl.CsclEventLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public CsclEvent addCsclEvent(CsclEvent csclEvent);
	...
	public CsclEvent createCsclEvent(long eventId);
	...
	public CsclEvent deleteCsclEvent(CsclEvent csclEvent);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CsclEvent deleteCsclEvent(long eventId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CsclEvent fetchCsclEvent(long eventId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CsclEvent getCsclEvent(long eventId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CsclEvent> getCsclEvents(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CsclEvent updateCsclEvent(CsclEvent csclEvent);
