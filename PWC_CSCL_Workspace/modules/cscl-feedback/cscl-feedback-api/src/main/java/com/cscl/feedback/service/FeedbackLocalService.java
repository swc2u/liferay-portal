...
public interface FeedbackLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FeedbackLocalServiceUtil} to access the feedback local service. Add custom service methods to <code>com.cscl.feedback.service.impl.FeedbackLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
