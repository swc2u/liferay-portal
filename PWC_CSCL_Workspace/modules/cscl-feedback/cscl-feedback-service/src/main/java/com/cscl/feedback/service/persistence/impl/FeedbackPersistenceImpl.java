...
package com.cscl.feedback.service.persistence.impl;

import com.cscl.feedback.exception.NoSuchFeedbackException;
import com.cscl.feedback.model.Feedback;
import com.cscl.feedback.model.impl.FeedbackImpl;
import com.cscl.feedback.model.impl.FeedbackModelImpl;
import com.cscl.feedback.service.persistence.FeedbackPersistence;
import com.cscl.feedback.service.persistence.impl.constants.FeedbackPersistenceConstants;
...
public class FeedbackPersistenceImpl
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, FeedbackImpl.class, primaryKey);
		}
	}
	...
	@Override
	@Reference(
		target = FeedbackPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.cscl.feedback.model.Feedback"),
			true);
	}

	@Override
	@Reference(
		target = FeedbackPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	static {
		try {
			Class.forName(FeedbackPersistenceConstants.class.getName());
		}
