...
/**
 * Provides the local service interface for CsclAgeFilter. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CsclAgeFilterLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CsclAgeFilterLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CsclAgeFilterLocalServiceUtil} to access the cscl age filter local service. Add custom service methods to <code>com.cscl.polls.service.impl.CsclAgeFilterLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
