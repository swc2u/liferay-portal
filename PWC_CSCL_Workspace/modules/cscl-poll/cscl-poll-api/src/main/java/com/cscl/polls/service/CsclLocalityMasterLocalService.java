...
/**
 * Provides the local service interface for CsclLocalityMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CsclLocalityMasterLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CsclLocalityMasterLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CsclLocalityMasterLocalServiceUtil} to access the cscl locality master local service. Add custom service methods to <code>com.cscl.polls.service.impl.CsclLocalityMasterLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
