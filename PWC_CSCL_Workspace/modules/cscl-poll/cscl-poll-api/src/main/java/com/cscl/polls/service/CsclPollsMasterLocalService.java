...
/**
 * Provides the local service interface for CsclPollsMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CsclPollsMasterLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CsclPollsMasterLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CsclPollsMasterLocalServiceUtil} to access the cscl polls master local service. Add custom service methods to <code>com.cscl.polls.service.impl.CsclPollsMasterLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CsclPollsMaster> getPollsByAgeAndLocality(
		long entryId, Date age, int locality);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CsclPollsMaster> getPollsByAgeAndSex(
		long entryId, Date age, String sex);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CsclPollsMaster> getPollsByLocalities(
		long entryId, int locality);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CsclPollsMaster> getPollsByLocalityAndSex(
		long entryId, int locality, String sex);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CsclPollsMaster> getPollsByLocalityAndSexAndAge(
		long entryId, int locality, String sex, Date age);
