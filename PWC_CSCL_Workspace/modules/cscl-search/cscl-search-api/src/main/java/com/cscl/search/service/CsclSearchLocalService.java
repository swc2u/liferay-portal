...
/**
 * Provides the local service interface for CsclSearch. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CsclSearchLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CsclSearchLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CsclSearchLocalServiceUtil} to access the cscl search local service. Add custom service methods to <code>com.cscl.search.service.impl.CsclSearchLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CsclSearch> fetchSearchResultByKeyword(
