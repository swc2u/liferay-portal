...
package com.cscl.search.service.persistence.impl.constants;
...
public class SearchPersistenceConstants {
	...
	public static final String BUNDLE_SYMBOLIC_NAME = "com.cscl.search.service";
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			SearchPersistenceConstants.class);
