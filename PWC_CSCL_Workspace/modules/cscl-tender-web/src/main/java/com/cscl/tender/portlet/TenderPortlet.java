package com.cscl.tender.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Tender",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/tender/view.jsp",
...
public class TenderPortlet extends MVCPortlet {
	...
	public void addTempAttachment(
		...
		try (InputStream inputStream = uploadPortletRequest.getFileAsStream(
			...
			DLAppServiceUtil.addTempFileEntry(themeDisplay.getScopeGroupId(), DLFolderConstants.DEFAULT_PARENT_FOLDER_ID, TenderPortletKeys.TEMP_FOLDER_NAME, sourceFileName, inputStream, mimeType);
		}
		catch (Exception e) {
	...
	public void deleteTempAttachment(
		...
		try {
			DLAppServiceUtil.deleteTempFileEntry(themeDisplay.getScopeGroupId(), DLFolderConstants.DEFAULT_PARENT_FOLDER_ID, TenderPortletKeys.TEMP_FOLDER_NAME, fileName);
