...
/**
 * Provides the local service interface for CsclTenderCategory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CsclTenderCategoryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CsclTenderCategoryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CsclTenderCategoryLocalServiceUtil} to access the cscl tender category local service. Add custom service methods to <code>com.cscl.tender.service.impl.CsclTenderCategoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CsclTenderCategory> getCsclTenderCategories(int start, int end);
