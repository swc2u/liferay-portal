...
/**
 * Provides the local service utility for CsclTenderCategory. This utility wraps
 * <code>com.cscl.tender.service.impl.CsclTenderCategoryLocalServiceImpl</code> and
 ...
 */
@ProviderType
public class CsclTenderCategoryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.cscl.tender.service.impl.CsclTenderCategoryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.cscl.tender.model.CsclTenderCategory
		addCsclTenderCategory(
			com.cscl.tender.model.CsclTenderCategory csclTenderCategory) {

		return getService().addCsclTenderCategory(csclTenderCategory);
	}
	 ...
	 */
	public static com.cscl.tender.model.CsclTenderCategory
		createCsclTenderCategory(long tenderCatId) {

		return getService().createCsclTenderCategory(tenderCatId);
	}
	 ...
	 */
	public static com.cscl.tender.model.CsclTenderCategory
		deleteCsclTenderCategory(
			com.cscl.tender.model.CsclTenderCategory csclTenderCategory) {

		return getService().deleteCsclTenderCategory(csclTenderCategory);
	}
	 ...
	 */
	public static com.cscl.tender.model.CsclTenderCategory
			deleteCsclTenderCategory(long tenderCatId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deleteCsclTenderCategory(tenderCatId);
	}
	...
	public static com.cscl.tender.model.CsclTenderCategory
		fetchCsclTenderCategory(long tenderCatId) {

		return getService().fetchCsclTenderCategory(tenderCatId);
	}
	 ...
	 */
	public static java.util.List<com.cscl.tender.model.CsclTenderCategory>
		getCsclTenderCategories(int start, int end) {

		return getService().getCsclTenderCategories(start, end);
	}
	 ...
	 */
	public static int getCsclTenderCategoriesCount() {
		return getService().getCsclTenderCategoriesCount();
	}
	 ...
	 */
	public static com.cscl.tender.model.CsclTenderCategory
			getCsclTenderCategory(long tenderCatId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getCsclTenderCategory(tenderCatId);
	}
	 ...
	 */
	public static com.cscl.tender.model.CsclTenderCategory
		updateCsclTenderCategory(
			com.cscl.tender.model.CsclTenderCategory csclTenderCategory) {

		return getService().updateCsclTenderCategory(csclTenderCategory);
	}

	public static CsclTenderCategoryLocalService getService() {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CsclTenderCategoryLocalService.class);
					...
					new ServiceTracker
						<CsclTenderCategoryLocalService,
						 CsclTenderCategoryLocalService>(
							 ...
							 CsclTenderCategoryLocalService.class, null);
