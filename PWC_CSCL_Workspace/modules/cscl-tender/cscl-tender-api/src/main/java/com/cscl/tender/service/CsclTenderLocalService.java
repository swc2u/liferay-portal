...
/**
 * Provides the local service interface for CsclTender. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CsclTenderLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CsclTenderLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CsclTenderLocalServiceUtil} to access the cscl tender local service. Add custom service methods to <code>com.cscl.tender.service.impl.CsclTenderLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
